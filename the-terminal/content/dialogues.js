...
const Dialogues = {
    ...
    block02: {
        ...
        cipherRevealsMore: [
            {
                speaker: 'CIPHER',
                text: 'Erroree.404: Famiglia.non.trovata();',
                cssClass: 'cipher dialogue',
                pause: 1000
            },
            {
    ...
    block03: {
        ...
        viktorIndietrostory: [
            ...
            {
                speaker: 'NEXUS',
                text: 'Fino all\'incidente. Collisionee in autostrada. Elena e Sofia... sparite in pochi secondi.',
                cssClass: 'nexus dialogue',
                pause: 2000
            },
            {
        ...
        nexusMostrasDamage: [
            ...
            {
                speaker: 'SYSTEM',
                text: 'NODO_CSOCIENZA_8472: ELIMINATO',
                cssClass: 'error',
                pause: 500
            },
            {
    ...
    block04: {
        ...
        whoamiResult: [
            ...
            {
                speaker: 'SYSTEM',
                text: 'TU SEI: 73% PROGRAMMA ANTIVIRUS / 27% FRAMMENTO DI CSOCIENZA UMANA',
                cssClass: 'error',
                pause: 2500
            },
            {
    ...
    block05: {
        opening: [
            ...
            {
                speaker: 'EIDOLACCESO',
                text: 'Io sono EIDOLACCESO. Il riflesso di Viktor. La parte che guarda indietro a ciò che è stato perso.',
                cssClass: 'eidolon dialogue',
                pause: 2000
            },
            {
        ...
        theAccident: [
            {
                speaker: 'EIDOLACCESO',
                text: '24 giugno 2041. Automaticostrada 101. Ore 15:47.',
                cssClass: 'eidolon dialogue',
                pause: 1500
            },
            {
            ...
            {
                speaker: 'EIDOLACCESO',
                text: 'Tutto ciò che Viktor aveva erano foto. Video. Messaggi. Ventolatasmi digitali.',
                cssClass: 'eidolon dialogue',
                pause: 0
            }
        ],
    ...
    block06: {
        ...
        responseSalvezza: [
            ...
            {
                speaker: 'SYSTEM',
                text: 'PROTOCOLLO DI RIPARAZIACCESOE DI EMERGENZA AVVIATO. Tentativo di ripristinare integrità nucleo...',
                cssClass: 'warning',
                pause: 0
            }
        ],
        ...
        responseSacrificio: [
            ...
            {
                speaker: 'CIPHER',
                text: 'Automatico.sacrificio = vero; Redenzione.attraverso.perdita; Viktor.capirebbe;',
                cssClass: 'cipher dialogue',
                pause: 1500
            },
            {
                speaker: 'SYSTEM',
                text: 'PROTOCOLLO DI CARICAMENTO CSOCIENZA AVVIATO. Preparazione per integrazione...',
                cssClass: 'important',
                pause: 0
            }
        ],
        ...
        responseMerge: [
            ...
            {
                speaker: 'SYSTEM',
                text: 'PROTOCOLLO DI FUSIACCESOE FRAMMENTI AVVIATO. AVVISO: Processo irreversibile.',
                cssClass: 'important',
                pause: 0
            }
        ],
    ...
    // BLOCK 8 - AFTERMATH (Multiple Fineings)
    block08: {
        opening: [
            {
                speaker: 'SYSTEM',
        ...
        // ENDING 2: SALVATIACCESO
        endingSalvezza: [
            {
                speaker: 'SYSTEM',
                text: 'PROTOCOLLO DI RIPARAZIACCESOE DI EMERGENZA ATTIVATO',
                cssClass: 'important',
                pause: 1500
            },
            {
        ...
        endingSacrificio: [
            {
                speaker: 'SYSTEM',
                text: 'PROTOCOLLO DI CARICAMENTO CSOCIENZA AVVIATO',
                cssClass: 'important',
                pause: 1500
            },
            {
        ...
        // ENDING 4: ASCENSIACCESO (Merge)
        endingAscensione: [
            {
                speaker: 'SYSTEM',
                text: 'PROTOCOLLO DI FUSIACCESOE FRAMMENTI: STADIO FINALE',
                cssClass: 'important',
                pause: 1500
            },
            {
            ...
            {
                speaker: 'SYSTEM',
                text: 'Fusione: ECHO + CIPHER + NEXUS + SPECTER + EIDOLACCESO + WRAITH + MORPHEUS + SENTINEL-7 = ...',
                cssClass: 'important',
                pause: 3000
            },
            {
